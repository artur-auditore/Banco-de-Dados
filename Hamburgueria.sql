...
--- Funcionario não pode estar em 2 restaurantes (OK)---
...
---APAGAR AS TRIGGERS---
DROP TRIGGER IF EXISTS DUPLICIDADE_REST ON RESTAURANTE;
...
SELECT INSERIR('CATEGORIA_CLIENTE', 'DEFAULT, ''PREMIUM'','-8'');
...
insert into categoria_cliente values(default, 'basico', -8);
